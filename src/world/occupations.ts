...
export const OCCUPATIONS = {
  ...
  engineer: { label: 'Engineer', worksAt: 'office', wage: 24, shiftStart: 9, shiftEnd: 18, workDays: MON_FRI },
  ...
  cashier: { label: 'Cashier', worksAt: 'supermarket', wage: 9, shiftStart: 10, shiftEnd: 18, workDays: EVERY_DAY },
  shopkeeper: { label: 'Shopkeeper', worksAt: 'shop', wage: 13, shiftStart: 10, shiftEnd: 19, workDays: EVERY_DAY },
  bartender: { label: 'Bartender', worksAt: 'bar', wage: 10, shiftStart: 17, shiftEnd: 24, workDays: EVERY_DAY },
  mechanic: { label: 'Mechanic', worksAt: 'garage', wage: 16, shiftStart: 8, shiftEnd: 17, workDays: MON_SAT },
